...
<form action="">
	<div class="ticketinglay1">
		...
		<div class="lay1_1">
			...
			<div class="timelist">
				<div class="timelist1"><a href="?movietitle=<%=request.getParameter("movietitle") %>&dal=<%=request.getParameter("dal") %>&el=<%=request.getParameter("el") %>&sectorno=${a.sectorno}">${a.sectorno }</a></div>
				<div class="timelist2">
